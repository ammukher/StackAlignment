...
bool Xform::execute() {
	...
	for (size_t ty=0; ty<90; ++ty){
		...
		for (size_t tx=0; tx<120; ++tx) {
			...
			oval[0] = static_cast<unsigned char>(vnl_math_min(255,value[0]));
			oval[1] = static_cast<unsigned char>(vnl_math_min(255,value[1]));
			oval[2] = static_cast<unsigned char>(vnl_math_min(255,value[2]));
...
int main( int argc, char * argv[] ) {
	...
	//string param("PMD789&788-N1-2011.10.13-17.55.13_PMD788_1_0001,/nfs/data/main/M8/mba_converted_imaging_data/PMD789&788/PMD788_JP2,-189.745,-244.392,0.970336,-0.241762,312,316,0,33.745,86.392,-11.2356,-138.644,0,0,0,");
